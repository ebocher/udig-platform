...
class H2GISResourceInfo extends IGeoResourceInfo {

	private H2GISGeoResource2 owner;

	H2GISResourceInfo(H2GISGeoResource2 owner) throws IOException {
		this.owner = owner;
	...
	public synchronized ReferencedEnvelope getBounds() {
        if (bounds == null) {
            ...
            try {
                ...
                H2GISPlugin.log("Could not establish bounds of dataset.", e); //$NON-NLS-1$
            ...
            try {
                ...
                H2GISPlugin.log("H2GIS unable to calculate bounds directly: "+e, e); //$NON-NLS-1$
            }
            if (bounds == null) {
                try {
                    ...
                    CatalogPlugin
                            ...
                            .log(new org.eclipse.core.runtime.Status(
                                    IStatus.WARNING,
                                    "org.locationtech.udig.catalog", 0, Messages.H2GISGeoResource_error_layer_bounds, e)); //$NON-NLS-1$
                    bounds = new ReferencedEnvelope(new Envelope(), null);
                }
            }
        }
